import{$ as e,M as b,x as L,i as F,d as y,a as p,j as f,k as u,N as c,y as U,T as q,z as R,p as M,b as _,q as E,c as N,r as P,A as B,t as G,e as H,h as A,v as V,o as W}from"./biwin-tt5_yjcm.js";let l=!1,r=[];async function h(){try{const a=M("wiFestividades");if(a&&!l)return x(a);r=(await _(E(N(p,"festividades"),P("orden")))).docs.map(i=>({id:i.id,...i.data()})),u("wiFestividades",r,24),x(r)}catch(a){console.error("Error festividades:",a),c("Error al cargar festividades","error")}}function x(a){window.festividadesGlobal=a;const t=`
