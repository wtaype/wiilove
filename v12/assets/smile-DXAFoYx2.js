import{$ as e,M as b,c as L,s as F,d as y,a as p,b as f,e as u,N as c,f as U,T as q,g as R,h as M,i as _,q as E,j as N,o as P,k as B,l as G,w as H,m as A,n as V,p as W}from"./biwin-RRZ_YcqS.js";let l=!1,r=[];async function g(){try{const a=M("wiFestividades");if(a&&!l)return x(a);r=(await _(E(N(p,"festividades"),P("orden")))).docs.map(i=>({id:i.id,...i.data()})),u("wiFestividades",r,24),x(r)}catch(a){console.error("Error festividades:",a),c("Error al cargar festividades","error")}}function x(a){window.festividadesGlobal=a;const t=`
